...
Invoke-BuildStage -Name "Build" -Filters $Stages -Script {
    ...
    Write-Information "Templating Noveris.GitHubApi.psd1"
    Format-TemplateFile -Template source/Noveris.GitHubApi.psd1.tpl -Target source/Noveris.GitHubApi/Noveris.GitHubApi.psd1 -Content @{
    ...
    Install-PSModuleFromManifest -ManifestPath source/Noveris.GitHubApi/Noveris.GitHubApi.psd1

    # Test the module manifest
    Write-Information "Testing module manifest"
    Test-ModuleManifest source/Noveris.GitHubApi/Noveris.GitHubApi.psd1

    # Import modules as test
    Write-Information "Importing module"
    Import-Module ./source/Noveris.GitHubApi/Noveris.GitHubApi.psm1
}

Invoke-BuildStage -Name "Publish" -Filters $Stages -Script {
    # Publish module
    Publish-Module -Path ./source/Noveris.GitHubApi -NuGetApiKey $Env:NUGET_API_KEY
}
